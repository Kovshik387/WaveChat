...
public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<CorporateMessengerContext>
{
    public CorporateMessengerContext CreateDbContext(string[] args)
    {
